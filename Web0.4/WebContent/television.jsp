...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t1.jpg" class="main-img" alt="">
                <img src="img/television/t11.png"  class="hover-img" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t2.jpg"  class="main-img" alt="">
                <img src="img/television/t22.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t3.jpg" class="main-img" alt="">
                <img src="img/television/t33.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t4.jpg" class="main-img" alt="">
                <img src="img/television/t4.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t5.jpg" class="main-img" alt="">
                <img src="img/television/t5.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t6.jpg" class="main-img" alt="">
                <img src="img/television/t6.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t8.jpg" class="main-img" alt="">
                <img src="img/television/t8.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t7.jpg" class="main-img" alt="">
                <img src="img/television/t7.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/television/t9.jpg" class="main-img" alt="">
                <img src="img/television/t9.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
