...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/w2.jpg" class="main-img" alt="">
                <img src="img/Watch/w2.jpg"  class="hover-img" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/w6.jpg"  class="main-img" alt="">
                <img src="img/Watch/w6.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/w4.jpg" class="main-img" alt="">
                <img src="img/Watch/w4.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/w1.jpg" class="main-img" alt="">
                <img src="img/Watch/w1.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/w3.jpg" class="main-img" alt="">
                <img src="img/Watch/w3.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/w7.jpg" class="main-img" alt="">
                <img src="img/Watch/w7.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/watch-3.jpg" class="main-img" alt="">
                <img src="img/Watch/watch-3.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/watch-1.jpg" class="main-img" alt="">
                <img src="img/Watch/watch-1.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/Watch/watch-2.jpg" class="main-img" alt="">
                <img src="img/Watch/watch-2.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
