...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h1.jpg" class="main-img" alt="">
                <img src="img/phone/h1.jpg"  class="hover-img" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h7.jpg"  class="main-img" alt="">
                <img src="img/phone/h7.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h2.jpg" class="main-img" alt="">
                <img src="img/phone/h2.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h3.jpg" class="main-img" alt="">
                <img src="img/phone/h3.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h4.jpg" class="main-img" alt="">
                <img src="img/phone/h4.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h5.jpg" class="main-img" alt="">
                <img src="img/phone/h5.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h6.jpg" class="main-img" alt="">
                <img src="img/phone/h6.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/phone/h8.jpg" class="main-img" alt="">
                <img src="img/phone/h8.jpg" class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
