...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="img/smartphone/ip13pro.jpg"  class="main-img" alt="">
                <img src="img/smartphone/ip13pro1.jpg"  class="hover-img" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="img/smartphone/sámum12.jpg"  class="main-img" alt="">
                <img src="img/smartphone/sámum12.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/smartphone/ipad2.jpg"  class="main-img" alt="">
                <img src="img/smartphone/ipad3.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/smartphone/oppo.jpg"  class="main-img" alt="">
                <img src="img/smartphone/oppo.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/smartphone/vsmart.jpg"  class="main-img" alt="">
                <img src="img/smartphone/vsmart.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
        ...
        <div class="box">
            <div class="image">
                <img src="img/smartphone/rog5.jpg"  class="main-img" alt="">
                <img src="img/smartphone/rog5.jpg"  class="hover-img" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-shopping-cart"></a>
                    <a href="#" class="fas fa-search-plus"></a>
                    <a href="#" class="fas fa-heart"></a>
