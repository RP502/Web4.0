												...
												<div class="quick-image">
													<div class="single-quick-image tab-content text-center">
														...
														<div class="tab-pane  fade in active"
															...
															<img
																src="assets/img/shop/product/<%=list.getAnhChiTiet()%>"
																alt="" />
														</div>
														<%
															} else {
															...
															<div class="row">
																<div class="col-sm-12 col-md-6">
																	<div class="por-dse clearfix">
																		<ul>
																			<li class="share-btn clearfix"><span>Love</span> <a href="#"><i class="fa fa-thumbs-up"></i></a>
																			</li>
																...
																<div class="col-sm-12 col-md-6">
																	<div class="por-dse add-to">
																		<a href="HomeCartServlet?status=add&id_product=<%=ls.getId()%>">Buy Now<i class="fa fa-cart-plus"></i></a>
																	</div>
																</div>
															</div>
														</div>
